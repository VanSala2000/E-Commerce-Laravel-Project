...
<div class="form">
  <div class="container mt-1 shadow-lg p-2 mb-4">
    ...
    <ul class="nav flex-column" style="cursor: pointer;">
      <li class="nav-item">
        <a class="nav-link" style="color: black;" id="btn1" disabled>Delete Product</a>
      </li>
    </ul>
    <ul class="nav flex-column" style="cursor: pointer;">
      <li class="nav-item">
        ...
        <div class="container mb-5">
            ...
            <table class="table table-striped table-hover table-light">
                ...
                <tr style="color: black">
                    ...
                    <td style="padding: 10px;font-size:20px;text-align:center"><b>Price</b></td>
                ...
                <tr style="font-size: 15px">
                    ...
                    <td style="text-align:center"><a class="btn btn-danger" href="{{ url('deleteorder',$cart->id) }}">Delete</a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
