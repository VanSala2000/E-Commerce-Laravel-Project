  ...
  <div id="innerPage">
    <div class="row align-items-center justify-content-center">
      ...
      <div class="col-sm-6 col-xs-12 text-white p-5">
       ...
       <form action="{{ route('adminvalidate') }}" method="POST">
        @csrf
        <input class="form-control rounded-0 mb-3" type="text" name="username" placeholder="Enter Username" />
       ...
       <a href="{{ route('welcome') }}"><button class="btn btn-danger mt-4 w-150"><i class="fa fa-arrow-left" aria-hidden="true"></i>  Go Back</button></a>
      </div>
    </div>
  </div>
</div>
