...
<div class="form">
  <div class="container mt-1 shadow-lg p-2 mb-4">
    ...
    <ul class="nav flex-column" style="cursor: pointer;">
      <li class="nav-item">
        <a class="nav-link" style="color: black;" id="btn1">Edit Product</a>
      </li>
    </ul>
    <ul class="nav flex-column" style="cursor: pointer;">
      <li class="nav-item">
  ...
  <div class="container shadow-lg ">
    <span class="rounded">
     ...
     @endif
      ...
      <h2 style="text-align: center"><b> Update Product </b></h2><br>

      <form action="{{ url('update-item/'.$profile->id ) }}" method="POST">
        {{ csrf_field() }}
         @method('PUT')
    ...
    <div class="row">
        ...
        <select class="form-control" name="cate_id" style="margin-left: 100px; width: 300px" required="">
            <option value="" selected="">{{ $profile->cate_id }}</option>
        ...
        <div class="form-group">
            <label><b style="font-size: 18px">Product Name:</b></label>
                <input type="text" value="{{ $profile->title }}" name="title" class="form-control" style="width: 400px; margin-left: 100px" placeholder="Enter product name" required="">
        </div>
    </div>
    </div>   
    ...
    <div class="row">
        ...
        <label><b style="font-size: 18px">Image:</b></label>
            <select class="form-control" name="image" style="margin-left: 100px; width: 300px" required="">
                <option value="" selected="">{{ $profile->image }}</option>
                @foreach ($product as $products)
    ...
    <div class="row">
        ...
        <label><b style="font-size: 18px">Description:</b></label>
            <input name="description" value="{{ $profile->description }}" class="form-control" style="width: 300px; margin-left: 100px; margin-bottom:5px" placeholder="Write a description" required="">
        </div>
    </div>
        <div class="col-4 col-md-4">
        <div class="form-group">
        <label><b style="font-size: 18px">Quantity:</b></label>
            <input type="number" value="{{ $profile->quantity }}" name="quantity" min="1" class="form-control" style="width: 150px; margin-left: 100px" placeholder="Enter quantity" required="">
        </div>
    </div>
    </div>
    ...
    <div class="row">
        ...
        <label><b style="font-size: 18px">Price:</b></label>
            <input type="number" value="{{ $profile->price }}" name="price" min="1" class="form-control" style="width: 200px; margin-left: 100px" placeholder="Write a price" required="">
        </div>
    </div>
        <div class="col-4 col-md-4">
        <div class="form-group">
        <label><b style="font-size: 18px">Status:</b></label>
            <input type="number" value="{{ $profile->status }}" min="0" max="0" name="status" class="form-control" style="width: 100px; margin-left: 100px; margin-bottom: 20px" required="">
        </div>
    </div>
    </div>

    <input type="submit" style="margin-left: 100px; margin-bottom: 100px" value="Update Product" class="btn btn-success">
</form>
    </span>
  </div>
</div>
