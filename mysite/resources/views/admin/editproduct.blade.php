...
<div class="form">
  <div class="container mt-1 shadow-lg p-2 mb-4">
    ...
    <ul class="nav flex-column" style="cursor: pointer;">
      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.delete')}}" style="color: black;" id="btn" disabled>Delete Product</a>
      </li>
    </ul>
    <ul class="nav flex-column" style="cursor: pointer;">
      <li class="nav-item">
        ...
        <div class="container mb-5">
            ...
            <table class="table table-striped table-hover table-light">
                ...
                <tr style="color: black">
                    <td style="padding: 10px;font-size:20px;text-align:center"><b>Category Id</b></td>   
                    <td style="padding: 10px;font-size:20px;text-align:center"><b>Product Name</b></td>
                    <td style="padding: 10px;font-size:20px;text-align:center"><b>Type</b></td>
                    <td style="padding: 10px;font-size:20px;text-align:center"></td>
                </tr>
                </thead>
                <tbody>
                @foreach ($carts as $cart)
                <tr style="font-size: 15px">
                    <td style="text-align:center">{{$cart->cate_id}}</td>
                    <td style="text-align:center">{{$cart->title}}</td>
                    <td style="text-align:center">{{$cart->type}}</td>
                    <td style="text-align:center"><a class="btn btn-primary" href="{{ url('updateproduct/'.$cart->id) }}">Update</a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
